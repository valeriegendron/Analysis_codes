...
fileName = "g000000"  # the file to read in
fileName2 = "g000061"  # the file to read in
fileName3 = "g000129"  # the file to read in
fileName4 = "g000178"  # the file to read in
fileName5 = "g000203"  # the file to read in
fileName6 = "g000256"  # the file to read in
columns = (0, 2)  # List of the columns to plot. 0=1st column, 1=2nd column, etc
nbins = [150, 150]  # number of "bins" in each direction
pic_name = "I_gmap_xz.png"  # set the name of the file to whatever you want
xcut = 0.05  # max extent for x axis in 100s of kpc
ycut = 0.05  # max extent for z axis in 100s of kpc
lim = 5  # max extent for x and z axi in kpc
v_min = 1E5
v_max = 2E7
xlabel = "rayon [kpc]"  # labels for axes
ylabel = "rayon [kpc]"
cbarlabel = "density [M$_\odot / pc^2$]"
title = "Galaxy I gas density"  # title of graph
