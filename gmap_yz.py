...
fileName6 = "g000203"  # the file to read in
columns = (1, 2)  # List of the columns to plot. 0=1st column, 1=2nd column, etc
nbins = [150, 150]  # number of "bins" in each direction
pic_name = "I_gmap_yz.png"  # set the name of the file to whatever you want
xcut = 0.05  # max extent for y axis in 100s of kpc
ycut = 0.05  # max extent for z axis in 100s of kpc
lim = 5  # max extent for y and z axi in kpc
v_min = 1E5
v_max = 2E7
