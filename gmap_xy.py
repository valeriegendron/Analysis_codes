...
pic_name = "I_gmap-20kpc.png"  # set the name of the file to whatever you want
xcut = 0.2  # max extent for x axis in 100s of kpc
ycut = 0.2  # max extent for y axis in 100s of kpc
lim = 20  # max extent for x and y axis in kpc
v_min = 1E5
# v_max = 2E6  # pour 5 kpc par 5 kpc
v_max = 5E6  # pour 20 kpc par 20 kpc
